namespace Anil.Core.Http
{
    /// <summary>
    /// Represents default values related to HTTP features
    /// </summary>
    public static partial class AnilHttpDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string IsPostBeingDoneRequestItem => "anil.IsPOSTBeingDone";
        ...
        /// </summary>
        public static string GenericRouteInternalRedirect => "anil.RedirectFromGenericPathRoute";
    }
}