...
using Anil.Core.Infrastructure.DependencyManagement;
...
namespace Anil.Core.Infrastructure
{
    ...
    /// </summary>
    public class AnilEngine : IEngine
    {
        #region Fields
        ...
        public virtual void RegisterDependencies(ContainerBuilder containerBuilder, AnilConfig nopConfig)
        {
            //register engine
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = _typeFinder.FindClassesOfType<IAnilStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IAnilStartup)Activator.CreateInstance(startup))
        ...
        public void ConfigureRequestPipeline(IApplicationBuilder application)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IAnilStartup>();
