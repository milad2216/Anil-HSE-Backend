...
namespace Anil.Core.Infrastructure
{
    ...
    /// </summary>
    public partial class AnilFileProvider : PhysicalFileProvider, IAnilFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a AnilFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public AnilFileProvider(IWebHostEnvironment webHostEnvironment)
