...
namespace Anil.Core.Configuration
{
    /// <summary>
    ...
    public partial class AppSettingsHelper
    {
        ...
        public static AppSettings SaveAppSettings(IList<IConfig> configurations, IAnilFileProvider fileProvider, bool overwrite = true)
        {
            ...
            var filePath = fileProvider.MapPath(AnilConfigurationDefaults.AppSettingsFilePath);
