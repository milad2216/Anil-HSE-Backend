...
namespace Anil.Web.Framework.Mvc.Filters
{
    ...
    public sealed class SaveLastVisitedPageAttribute : TypeFilterAttribute
    {
        ...
        private class SaveLastVisitedPageFilter : IAsyncActionFilter
        {
            ...
            public SaveLastVisitedPageFilter(IWebHelper webHelper,
            ...
            private async Task SaveLastVisitedPageAsync(ActionExecutingContext context)
            {
                ...
                //        .Equals(AnilCustomerDefaults.LastVisitedPageAttribute, StringComparison.InvariantCultureIgnoreCase));
                ...
                //        Key = AnilCustomerDefaults.LastVisitedPageAttribute,
