...
namespace Anil.Web.Framework.Infrastructure
{
    ...
    /// </summary>
    public partial class AuthenticationStartup : IAnilStartup
    {
        /// <summary>
        ...
        {
            //add data protection
            //services.AddAnilDataProtection();

            //add authentication
            services.AddAnilAuthentication(configuration);
        }
        ...
        public void Configure(IApplicationBuilder application)
        {
            ...
            application.UseAnilAuthentication();
        }
