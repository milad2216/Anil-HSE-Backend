...
namespace Anil.Web.Framework.Infrastructure.Mapper.Extensions
{
    /// <summary>
    ...
    public static class MappingExtensions
    {
        ...
        /// <param name="entities">List of Entity to map from</param>
        /// <returns>Mapped model</returns>
        public static List<TModel> ToModel<TEntity, TModel>(this List<TEntity> entities) where TEntity : BaseEntity where TModel : BaseAnilEntityModel
        {
            if (entities == null)
