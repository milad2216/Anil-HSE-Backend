...
using Anil.Data.Mapping.Builders;

namespace Anil.Data.Extensions
{
    /// <summary>
    ...
    public static class FluentMigratorExtensions
    {
        ...
        private static Dictionary<Type, Action<ICreateTableColumnAsTypeSyntax>> TypeMapping { get; } = new Dictionary<Type, Action<ICreateTableColumnAsTypeSyntax>>
        {
            ...
            [typeof(DateTime)] = c => c.AsAnilDateTime2(),
        ...
        /// </summary>
        public static ICreateTableColumnOptionOrWithColumnSyntax AsAnilDateTime2(this ICreateTableColumnAsTypeSyntax syntax)
        {
