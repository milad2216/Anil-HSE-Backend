...
using Anil.Data.DataProviders.Interceptors;
...
namespace Anil.Data.DataProviders
{
    public abstract partial class BaseDataProvider : IMappingEntityAccessor
    {
        ...
        protected static ConcurrentDictionary<Type, AnilEntityDescriptor> EntityDescriptors { get; } = new ConcurrentDictionary<Type, AnilEntityDescriptor>();
        ...
        public virtual void InitializeDatabase()
        {
            ...
            var targetAssembly = typeof(AnilDbStartup).Assembly;
        ...
        public virtual AnilEntityDescriptor GetEntityDescriptor(Type entityType)
        {
            return EntityDescriptors.GetOrAdd(entityType, t =>
            {
                ...
                return new AnilEntityDescriptor
                {
                    EntityName = tableName,
                    SchemaName = builder.Expression.SchemaName,
                    Fields = builder.Expression.Columns.Select(column => new AnilEntityFieldDescriptor
                    {
                        Name = column.Name,
