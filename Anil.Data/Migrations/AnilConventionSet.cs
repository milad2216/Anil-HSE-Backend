...
namespace Anil.Data.Migrations
{
    ...
    /// </summary>
    public class AnilConventionSet : IConventionSet
    {
        #region Ctor

        public AnilConventionSet(IAnilDataProvider dataProvider)
        {
