...
namespace Anil.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        /// <returns>Data settings</returns>
        public static DataConfig LoadSettings(IAnilFileProvider fileProvider = null, bool reload = false)
        {
            ...
            var filePath_json = fileProvider.MapPath(AnilDataSettingsDefaults.FilePath);
            var filePath_txt = fileProvider.MapPath(AnilDataSettingsDefaults.ObsoleteFilePath);
        ...
        /// <param name="fileProvider">File provider</param>
        public static void SaveSettings(DataConfig dataSettings, IAnilFileProvider fileProvider)
        {
            AppSettingsHelper.SaveAppSettings(new List<IConfig> { dataSettings }, fileProvider);
