...
namespace Anil.Services.Caching
{
    /// <summary>
        ...
        where TEntity : BaseEntity
    {
        ...
        {
            await RemoveByPrefixAsync(AnilEntityCacheDefaults<TEntity>.ByIdsPrefix);
            await RemoveByPrefixAsync(AnilEntityCacheDefaults<TEntity>.AllPrefix);

            if (entityEventType != EntityEventType.Insert)
                await RemoveAsync(AnilEntityCacheDefaults<TEntity>.ByIdCacheKey, entity);
