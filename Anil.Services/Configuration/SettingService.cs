...
namespace Anil.Services.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        {
            return await _staticCacheManager.GetAsync(AnilSettingsDefaults.SettingsAllAsDictionaryCacheKey, async () =>
            {
        ...
        {
            return _staticCacheManager.Get(AnilSettingsDefaults.SettingsAllAsDictionaryCacheKey, () =>
            {
        ...
        {
            await _staticCacheManager.RemoveByPrefixAsync(AnilEntityCacheDefaults<Setting>.Prefix);
        }
        ...
        {
            _staticCacheManager.RemoveByPrefix(AnilEntityCacheDefaults<Setting>.Prefix);
        }
