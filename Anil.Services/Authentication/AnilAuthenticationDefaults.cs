...
namespace Anil.Services.Authentication
{
    ...
    /// </summary>
    public static partial class AnilAuthenticationDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string ClaimsIssuer => "anilCommerce";
        ...
        /// </summary>
        public static string ExternalAuthenticationErrorsSessionKey => "anil.externalauth.errors";
    }
}