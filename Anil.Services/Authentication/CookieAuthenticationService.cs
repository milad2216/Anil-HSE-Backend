...
namespace Anil.Services.Authentication
{
    /// <summary>
    ...
    public partial class CookieAuthenticationService : IAuthenticationService
    {
        ...
        //        claims.Add(new Claim(ClaimTypes.Name, customer.Username, ClaimValueTypes.String, AnilAuthenticationDefaults.ClaimsIssuer));

        //    if (!string.IsNullOrEmpty(customer.Email))
        //        claims.Add(new Claim(ClaimTypes.Email, customer.Email, ClaimValueTypes.Email, AnilAuthenticationDefaults.ClaimsIssuer));

        //    //create principal for the current authentication scheme
        //    var userIdentity = new ClaimsIdentity(claims, AnilAuthenticationDefaults.AuthenticationScheme);
        ...
        //    //sign in
        //    await _httpContextAccessor.HttpContext.SignInAsync(AnilAuthenticationDefaults.AuthenticationScheme, userPrincipal, authenticationProperties);
        ...
        //    await _httpContextAccessor.HttpContext.SignOutAsync(AnilAuthenticationDefaults.AuthenticationScheme);
        //}
        ...
        //    var authenticateResult = await _httpContextAccessor.HttpContext.AuthenticateAsync(AnilAuthenticationDefaults.AuthenticationScheme);
        ...
        //            && claim.Issuer.Equals(AnilAuthenticationDefaults.ClaimsIssuer, StringComparison.InvariantCultureIgnoreCase));
