...
namespace Anil.Services.Seo
{
    ...
    /// </summary>
    public partial interface IUrlRecordService : IBaseService<UrlRecord>
    {
        /// <summary>
        ...
        /// <returns>
        /// The result contains the found URL record
        /// </returns>
        ...
        /// </returns>
        Task<IPagedList<UrlRecord>> GetAllUrlRecordsAsync(string slug = "", bool? isActive = null, int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        /// The result contains the found url record
        /// </returns>
        UrlRecord? GetActiveSlugEntity(int entityId, string entityName);
        ...
        /// <param name="entityName">Entity name</param>
        /// <returns>
        /// The result contains the found slug
        /// </returns>
        ...
        /// The task result contains the search engine  name (slug)
        /// </returns>
        Task<string> GetSeNameAsync(int entityId, string entityName, bool ensureTwoPublishedLanguages = true);
