...
namespace Anil.Services.Seo
{
    ...
    /// </summary>
    public partial class UrlRecordService : BaseService<UrlRecord>, IUrlRecordService
    {
        #region Fields
        ...
        public UrlRecordService(IRepository<UrlRecord> urlRecordRepository,
            ...
            SeoSettings seoSettings) : base(urlRecordRepository, workContext)
        {
        ...
        public virtual UrlRecord? GetBySlug(string slug)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(AnilSeoDefaults.UrlRecordBySlugCacheKey, slug);
            ...
            var urlRecord = _staticCacheManager.Get(key, () =>
            {
        ...
        public virtual async Task<UrlRecord> GetBySlugAsync(string slug)
        {
            ...
            var urlRecord = await _staticCacheManager.GetAsync(key, async () =>
            {
        ...
        /// </returns>
        public virtual UrlRecord? GetActiveSlugEntity(int entityId, string entityName)
        {
            ...
            var slug = urlRecords.FirstOrDefault();
        ...
        {
            //gradual loading
            var key = _staticCacheManager.PrepareKeyForDefaultCache(AnilSeoDefaults.UrlRecordCacheKey, entityId, entityName);
        ...
        /// </returns>
        public virtual async Task<string> GetSeNameAsync<T>(T entity, bool returnDefaultValue = true,
            bool ensureTwoPublishedLanguages = true) where T : BaseEntity, ISlugSupported
        {
            ...
            return await GetSeNameAsync(entity.Id, entityName, ensureTwoPublishedLanguages);
        }
        ...
        /// The task result contains the search engine  name (slug)
        /// </returns>
        public virtual async Task<string> GetSeNameAsync(int entityId, string entityName, bool ensureTwoPublishedLanguages = true)
        {
            var result = await GetActiveSlugAsync(entityId, entityName);
        ...
        public virtual async Task<string> ValidateSeNameAsync(int entityId, string entityName, string seName, string name, bool ensureNotEmpty)
        {
            ...
            //max length
            seName = CommonHelper.EnsureMaximumLength(seName, AnilSeoDefaults.SearchEngineNameLength);
