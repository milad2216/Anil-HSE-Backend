...
namespace Anil.Services.Seo
{
    ...
    /// </summary>
    public static partial class AnilSeoDefaults
    {
        /// <summary>
        ...
        /// {2} : language ID
        /// </remarks>
        public static CacheKey UrlRecordCacheKey => new("Anil.urlrecord.{0}-{1}");
        ...
        /// {0} : slug
        /// </remarks>
        public static CacheKey UrlRecordBySlugCacheKey => new("Anil.urlrecord.byslug.{0}");
